...
- Makes underground Creepers more aggressive and unpredictable:
...
- Overhauls cave lighting and the Night Vision effect for better subterranean atmosphere:
...
- Adds Nightmare Awareness, an ominous new status effect that triggers dark subterranean ambushes:
...
- Supports and recommends companion mods that pair well with Grimdepth:
